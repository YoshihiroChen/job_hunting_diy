class PersonalityTestsController < ApplicationController
  ...
  ALL_JOBS = [
    ...
    { industry: "士业", role: "海事代理士", literature_ok: "★★★★☆", traits: ["外向", "理性", "谨慎", "创新", "随意", "领导", "现实", "自律"], note: "法规/文书/交涉" },
    { industry: "士业", role: "土地家屋調査士", literature_ok: "★★☆☆☆", traits: ["内向", "理性", "谨慎", "保守", "计划", "服从", "现实", "自律"], note: "测量/作图" },
    ...
    { industry: "IT咨询/SIer", role: "IT销售/解决方案销售", literature_ok: "★★★★☆", traits: ["外向", "理性", "果断", "创新", "计划", "领导", "现实", "自律"], note: "客户关系和沟通" },
    { industry: "IT咨询/SIer", role: "运营/客户支持", literature_ok: "★★★☆☆", traits: ["内向", "感性", "谨慎", "保守", "计划", "服从", "现实", "自律"], note: "用户沟通、协调" },

    # Web系IT
    { industry: "Web系IT", role: "Web开发工程师", literature_ok: "★☆☆☆☆", traits: ["内向", "理性", "谨慎", "创新", "计划", "服从", "现实", "自律"], note: "开发经验/技术" },
    { industry: "Web系IT", role: "后端/基础设施工程师", literature_ok: "★☆☆☆☆", traits: ["内向", "理性", "谨慎", "创新", "计划", "服从", "现实", "自律"], note: "编程/高阶技术" },
    { industry: "Web系IT", role: "前端工程师", literature_ok: "★☆☆☆☆", traits: ["内向", "理性", "谨慎", "创新", "计划", "服从", "现实", "自律"], note: "JS/HTML/CSS" },
    { industry: "Web系IT", role: "UI/UX设计师", literature_ok: "★★★☆☆", traits: ["内向", "感性", "果断", "创新", "随意", "服从", "理想", "自律"], note: "美术、体验、逻辑" },
    { industry: "Web系IT", role: "产品经理", literature_ok: "★★★☆☆", traits: ["外向", "理性", "果断", "创新", "计划", "领导", "理想", "自律"], note: "业务、技术、企划" },
    { industry: "Web系IT", role: "Web营销/广告运营", literature_ok: "★★★★☆", traits: ["外向", "理性", "果断", "创新", "随意", "领导", "理想", "自律"], note: "分析、企划、创新" },
    ...
    { industry: "Web系IT", role: "IT销售/客户经理", literature_ok: "★★★★☆", traits: ["外向", "理性", "果断", "创新", "随意", "领导", "现实", "自律"], note: "沟通、客户支持" },
    ...
    { industry: "主机游戏开发商", role: "デザイナー（Designer）", literature_ok: "★☆☆☆☆", traits: ["内向", "感性", "谨慎", "创新", "随意", "服从", "理想", "自律"], note: "需美术技能，门槛高" },
    ...
    { industry: "主机研发&游戏开发商", role: "ネットワークサービス開発", literature_ok: "★☆☆☆☆", traits: ["内向", "理性", "谨慎", "创新", "计划", "领导", "现实", "自律"], note: "网络服务，需技术背景" },
    ...
    { industry: "主机研发&游戏开发商", role: "UI/UXデザイン", literature_ok: "★★☆☆☆", traits: ["内向", "理性", "果断", "创新", "计划", "服从", "理想", "自律"], note: "UI/UX，有理科与文科复合型" },
    ...
    { industry: "主机研发&游戏开发商", role: "プロダクトデザイン（硬件）", literature_ok: "★☆☆☆☆", traits: ["内向", "理性", "果断", "创新", "计划", "服从", "理想", "自律"], note: "硬件设计，工业/理工" },
    ...
    { industry: "Web系游戏公司", role: "UIデザイナー", literature_ok: "★☆☆☆☆", traits: ["内向", "理性", "果断", "创新", "计划", "服从", "理想", "自律"], note: "UI美术，有作品集" },
    ...
    { industry: "Web系游戏公司", role: "iOS/Android エンジニア", literature_ok: "★☆☆☆☆", traits: ["内向", "理性", "谨慎", "创新", "计划", "服从", "现实", "自律"], note: "移动端开发，理工岗" },
    ...
    { industry: "Web系游戏公司", role: "宣伝プランナー", literature_ok: "★★★★★", traits: ["外向", "感性", "果断", "创新", "计划", "领导", "理想", "冲动"], note: "宣传企划，创意表达" },
    { industry: "Web系游戏公司", role: "グローバル事業職", literature_ok: "★★★★★", traits: ["外向", "理性", "果断", "创新", "计划", "领导", "理想", "自律"], note: "国际业务，多语种" },
    { industry: "Web系游戏公司", role: "ローカライゼーション", literature_ok: "★★★★★", traits: ["内向", "理性", "果断", "创新", "计划", "服从", "理想", "自律"], note: "本地化，语言文科主力" },
